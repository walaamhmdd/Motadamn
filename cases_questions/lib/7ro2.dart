                      ...
                      children: <Widget>[
                        RichText(
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              TextSpan(
                                text: ' :درجة الحرق ' , style: TextStyle(
                                fontFamily: 'Century',
                                fontSize: 15,
                                fontWeight: FontWeight.w900,
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            Transform.translate(
                              offset: Offset(230,-36),
                              child: Text('الدرجه الخامسة',
                                style: TextStyle(
                                    fontFamily: 'Century',
                                    fontSize: 11,
                                    fontWeight: FontWeight.w800
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Transform.translate(offset: Offset(90,-110),
                              child: Text('لا'  ,
                                style: TextStyle(
                                    fontFamily: 'Century',
                                    fontSize: 13,
                            ...
                            Transform.translate(offset: Offset(80,-110),
                              child: Radio(
                                value: 7,
                                groupValue: group,
                                onChanged: (T){
                            ...
                            Transform.translate(offset: Offset(110,-110),
                              child: Text('نعم'  ,
                                style: TextStyle(
                                    fontFamily: 'Century',
                                    fontSize: 13,
                            ...
                            Transform.translate(offset: Offset(100,-110),
                              child: Radio(
                                value: 8,
                                groupValue: group,
                                onChanged: (T){
                        ...
                        Transform.translate(
                          ...
                          child: RichText(
                            text: TextSpan(
                              ...
                              children: <TextSpan>[
                                TextSpan(
                                  text: ': هل يستطيع العمل بعد علاج الحرق' , style: TextStyle(
                                  fontFamily: 'Century',
                                  fontSize: 15,
                                  fontWeight: FontWeight.w900,
                                  color: Color(0xff0064BF),
                        ...
                        SizedBox(height: 15,),
                        Transform.translate(
                          offset: Offset(13,-140),
                          child: RichText(
                            text: TextSpan(
                              text: '*',style: TextStyle(color: Colors.red ,fontWeight: FontWeight.bold),
                              children: <TextSpan>[
                                TextSpan(
                                  text: ': هل يحتاج لعملية تجميلية' , style: TextStyle(
                                  fontFamily: 'Century',
                                  fontSize: 15,
                                  fontWeight: FontWeight.w900,
                                  color: Color(0xff0064BF),
