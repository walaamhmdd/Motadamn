                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Transform.translate(
                        offset: Offset(-10,10),
                        child: Text('برنامج ذوي الإحتياجات الخاصة ',
                      ...
                      children: <Widget>[
                        ...
                        Transform.translate(
                          ...
                          child: RichText(
                            text: TextSpan(
                              ...
                              children: <TextSpan>[
                                TextSpan(
                                  text: 'هل الحالة فى خطر ؟ ' , style: TextStyle(
                                  fontFamily: 'Century',
                                  fontSize: 15,
                                  fontWeight: FontWeight.w900,
                                  color: Color(0xff0064BF),
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Transform.translate(offset: Offset(50,-70),
                              child: Text('لا'  ,
                                style: TextStyle(
                                    fontFamily: 'Century',
                                    fontSize: 13,
                            ...
                            Transform.translate(offset: Offset(40,-70),
                              child: Radio(
                                value: 7,
                                groupValue: group,
                                onChanged: (T){
                        ...
                        Transform.translate(
                          ...
                          child: RichText(
                            text: TextSpan(
                              ...
                              children: <TextSpan>[
                                TextSpan(
                                  text: 'هل يحتاج لرعاية خاصة (لا يستطيع التحرك -..)؟' , style: TextStyle(
                                  fontFamily: 'Century',
                                  fontSize: 15,
                                  fontWeight: FontWeight.w900,
                                  color: Color(0xff0064BF),
                       ...
                       // SizedBox(height: 15,),
                        Transform.translate(
                          ...
                          child: RichText(
                            text: TextSpan(
                              ...
                              children: <TextSpan>[
                                TextSpan(
                                  text: 'هل الإصابه في عضو حيوي ؟' , style: TextStyle(
                                  fontFamily: 'Century',
                                  fontSize: 15,
                                  fontWeight: FontWeight.w900,
                                  color: Color(0xff0064BF),
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Transform.translate(offset: Offset(50,-100),
                              child: Text('لا'  ,
                                style: TextStyle(
                                    fontFamily: 'Century',
                                    fontSize: 13,
                            ...
                            Transform.translate(offset: Offset(40,-100),
                              child: Radio(
                                value: 7,
                                groupValue: group,
                                onChanged: (T){
                     ...
                     //   SizedBox(height: 15,),
                        Transform.translate(
                          ...
                          child: RichText(
                            text: TextSpan(
                              ...
                              children: <TextSpan>[
                                TextSpan(
                                  text: 'هل يحتاج للسفر ؟' , style: TextStyle(
                                  fontFamily: 'Century',
                                  fontSize: 15,
                                  fontWeight: FontWeight.w900,
                                  color: Color(0xff0064BF),
                        ...
                        Transform.translate(
                          ...
                          child: RichText(
                            text: TextSpan(
                              ...
                              children: <TextSpan>[
                                TextSpan(
                                  text: 'هل يستطيع العمل بعد العلاج ؟' , style: TextStyle(
                                  fontFamily: 'Century',
                                  fontSize: 15,
                                  fontWeight: FontWeight.w900,
                                  color: Color(0xff0064BF),
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Transform.translate(offset: Offset(50,-130),
                              child: Text('لا'  ,
                                style: TextStyle(
                                    fontFamily: 'Century',
                                    fontSize: 13,
                            ...
                            Transform.translate(offset: Offset(40,-130),
                              child: Radio(
                                value: 7,
                                groupValue: group,
                                onChanged: (T){
