...
SizedBox(height: 10,),
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Transform.translate(offset: Offset(46,-110),
                              child: Text('من شهر حتي 6 أشهر '  ,
                                style: TextStyle(
                                    fontFamily: 'Century',
                                    fontSize: 9,
                                    fontWeight: FontWeight.w900
                            ...
                            Transform.translate(offset: Offset(38,-110),
                              child: Text(' أقل من شهر '  ,
                                style: TextStyle(
                                    fontFamily: 'Century',
                                    fontSize: 10,
                                    fontWeight: FontWeight.w900
                        ...
                        Transform.translate(
                          ...
                          child: RichText(
                            text: TextSpan(
                              ...
                              children: <TextSpan>[
                                TextSpan(
                                  text: 'هل يحتاج لزراعة قلب ويمتلك القلب ؟' , style: TextStyle(
                                  fontFamily: 'Century',
                                  fontSize: 15,
                                  fontWeight: FontWeight.w900,
                                  color: Color(0xff0064BF),
